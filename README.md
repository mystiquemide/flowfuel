...
- Client A (funded): run succeeded, real Orbio generation ID `gen-1789764124-zDWN726GvyqIjnwlEzKL`, exactly `$0.000108` drawn from A's balance. [Receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/4b1a2430-eaac-4dc8-9e23-870e55e0b6f4/receipt)
- Client B (unfunded): `HTTP 401`, no generation ID, no charge, no fallback to any other balance. [Receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/99181d0b-80c6-46f8-a1a0-4657a0d42846/receipt)
- A task priced above the balance: `HTTP 402`, nothing charged. [Receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/b2996733-816d-4748-a7fd-20759c940e7a/receipt)
...
1. Open [/agency](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/agency). Client A shows an activated balance, Client B shows none.
...
4. Open [/proof](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/proof) and click any run: task hash, generation ID, upstream status, cost, balance delta, explorer links.
...
| Artifact | Value | Link |
|---|---|---|
| Funded run receipt | `succeeded`, HTTP 200, $0.009088 - $0.000108 = $0.008980, reconciled | [receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/4b1a2430-eaac-4dc8-9e23-870e55e0b6f4/receipt) |
| Unfunded run receipt | `client_unfunded`, HTTP 401, zero cost, zero fallback | [receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/99181d0b-80c6-46f8-a1a0-4657a0d42846/receipt) |
| Over-quota run receipt | `402 insufficient_quota`, balance unchanged | [receipt](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/api/runs/b2996733-816d-4748-a7fd-20759c940e7a/receipt) |
...
| Client C credited balance | 0.008 direct + 0.122887 + 0.131362 exchange = $0.261849 activated, live in the gateway | [/agency](https://ubuntu-8gb-fsn1-2.tailb78ed9.ts.net:8443/agency) |
